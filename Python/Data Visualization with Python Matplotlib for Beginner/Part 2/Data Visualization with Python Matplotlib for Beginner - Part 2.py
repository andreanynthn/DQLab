...
Original file is located at
    https://colab.research.google.com/drive/1pkT78nmXT-v0cabzrLui0aROTuMUcyhd

<b>DATA VISUALIZATION WITH PYTHON MATPLOTLIB FOR BEGINNER - PART 2</b><br><br>
...
"""<b><i>2. Membuat Multi-line Chart dan Kustomisasi Lanjutan </i></b>

<i>2.1 Membuat Multi-Line Chat</i>
"""
...
"""<i>2.4 Membuat Line Chart GMV Breakdown by Top Provinces </i>"""
...
"""<b><i>3. Membuat Pie-Chart dan Bar-Chart</i></b>

<i>3.1 Membuat Subset Data</i>
"""

dataset_dki_q4 = dataset[(dataset['province']=='DKI Jakarta') & (dataset['order_month'] >= '2019-10')]
print(dataset_dki_q4.head())

"""<i>3.2 Membuat Pie Chart</i>"""
...
"""<i>3.3 Membuat Bar Chart</i>"""

plt.clf()
dataset_dki_q4.groupby('city')['gmv'].sum().sort_values(ascending = False).plot(kind = 'bar',
                                                                                color = 'green')
plt.title('GMV Per City - DKI Jakarta in Q4 2019', color = 'blue', pad = 30, fontsize = 20)
...
"""<i>3.4 Membuat Multi Bar Chart</i>"""
...
"""<b><i>4. Membuat Histogram dan Scatterplot</i></b>

<i>4.1 Membuat Agregat Data Customer</i>
"""

data_per_customer = dataset_dki_q4.groupby('customer_id').agg({'order_id' : 'nunique',
                                                             'quantity' : 'sum',
                                                             'gmv' : 'sum'}).reset_index().rename(columns = 
                                                                                                 {'order_id' : 'orders'})
print(data_per_customer.sort_values(by = 'orders', ascending = False))

"""<i>4.2 Membuat Histogram - Part 1</i>"""
...
"""<i>4.3 Membuat Histogram - Part 2</i>"""
...
"""<i>4.4 Membuat Histogram - Part 2</i>"""
...
<b><i>Case 1: Menentukan Brand Top 5</i></b>
"""
...
dataset_top5brand_dec = dataset[(dataset['order_month']=='2019-12') & (dataset['brand']
                                                                       .isin(top_brands['brand'].to_list()))]

# print top brands
print('Top 5 Brand\n\n', top_brands)

"""<b><i>Case 2: Multi-line Chart Daily Quantity untuk Brand Top 5</i></b>"""

dataset_top5brand_dec.groupby(['order_date','brand'])['quantity'].sum().unstack().plot(marker='.',
                                                                                       cmap='plasma')
plt.title('Daily Sold Quantity Dec 2019 - Breakdown by Brands',loc='center',
          pad=30, fontsize=15, color='blue') # membuat judul grafik
...
"""<b><i>Case 3: Kuantitas Penjualan Brand Top 5 Selama Desember 2019</i></b>"""
...
"""<b><i>Case 4: Penjulan Produk Di atas 100 dan Di bawah 100 Selama Desember 2019</i></b>"""
...
dataset_top5brand_dec_per_product['quantity_group'] = dataset_top5brand_dec_per_product['quantity'].apply(lambda x: '>= 100'
                                                                                                          if x>=100 else '< 100')
...
dataset_top5brand_dec_per_product.groupby(['brand','quantity_group'])['product_id'].nunique().reindex(index=s_sort.index,
                                                                                                      level='brand').unstack().plot(kind='bar', stacked=True)
...
"""<b><i>Case 5: Murah atau Mahalkah Harga Produk Brand Top 5</i></b>"""
...
"""<b><i>Case 6a: Korelasi Quantity vs GMV</i></b>"""
...
"""<b><i>Case 6b: Korelasi Median Harga vs Quantity</i></b>"""
